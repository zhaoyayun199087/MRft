...
public class CommonUtils {
    ...
    public static  int checkSum(int[] ints){
        int sum=0;
     ...
     * @return
     */
    public static int[] uniteInts(int[]... data) {
        int length = 0;
        for (int[] msg : data) {
            length += msg.length;
        }
    ...
    public static String decodeBytesToHexString(int[] data) {
        String result = new String();
        for (int dd : data) {
            result = result.concat(decodeByteToHexString((byte)dd)+" ");
        }
        return result;
    }
