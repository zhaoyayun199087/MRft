 ...
 */
public class ZhongxiaoLwAlertDialog extends BaseDialog{

    private TextView tvOk, tvPercent;
    private VocAletCallback  mCallback;
    private RoundProgressBar rpb;

    public ZhongxiaoLwAlertDialog(Context context, VocAletCallback rc) {
        super(context);
        InitApplication.isZhongxiao=false;
        mCallback = rc;
    }

    @Override
    protected void initView() {
        View  view=setView(R.layout.dialog_zhongxiao_lw_alert);
        ...
        tvOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                InitApplication.isZhongxiao=true;
                EventBus.getDefault().post(new ReceiverHcZero(0));
                mCallback.onOk();
                dismiss();
            }
        });
