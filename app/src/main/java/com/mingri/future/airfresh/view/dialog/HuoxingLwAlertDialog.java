 ...
 */
public class HuoxingLwAlertDialog extends BaseDialog{

    private TextView tvOk, tvPercent;
    private VocAletCallback  mCallback;
    private RoundProgressBar rpb;

    public HuoxingLwAlertDialog(Context context, VocAletCallback rc) {
        super(context);
        InitApplication.isHuoxing=false;
        mCallback = rc;
    }

    @Override
    protected void initView() {
        View  view=setView(R.layout.dialog_huoxing_lw_alert);
        ...
        tvOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                InitApplication.isHuoxing=true;
                EventBus.getDefault().post(new ReceiverHcZero(1));
                mCallback.onOk();
                dismiss();
            }
        });
