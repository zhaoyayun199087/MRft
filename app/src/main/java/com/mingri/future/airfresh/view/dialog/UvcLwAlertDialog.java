 ...
 */
public class UvcLwAlertDialog extends BaseDialog{

    private TextView tvOk, tvPercent;
    private VocAletCallback  mCallback;
    private RoundProgressBar rpb;

    public UvcLwAlertDialog(Context context, VocAletCallback rc) {
        super(context);
        InitApplication.isUVC=false;
        mCallback = rc;
    }

    @Override
    protected void initView() {
        View  view=setView(R.layout.dialog_uvc_alert);
        ...
        tvOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                InitApplication.isUVC=true;
                EventBus.getDefault().post(new ReceiverHcZero(3));
                mCallback.onOk();
                dismiss();
            }
        });
