...
public class RetrofitFactoryForCity {
    ...
    private static RetrofitFactoryForCity instance;
    ...
    public RetrofitFactoryForCity(Context context) {
        mContext = context.getApplicationContext();
        init(mContext, getBaseUrl(mContext));
    }

    public static RetrofitFactoryForCity getInstance(Context context) {
        if (instance == null) {
            synchronized (RetrofitFactoryForCity.class) {
                if (instance == null) {
                    instance = new RetrofitFactoryForCity(context);
                }
            }
        }
        return instance;
